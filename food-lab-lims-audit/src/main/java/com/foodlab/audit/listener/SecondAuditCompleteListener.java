...
public class SecondAuditCompleteListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        log.info("二级审核任务完成，流程实例ID：{}，任务ID：{}，审核结果：{}", processInstanceId, taskId, auditResult);

        AuditRecord auditRecord = auditRecordMapper.selectLatestByBusinessAndLevel("task", taskId, 2);
        if (auditRecord != null) {
